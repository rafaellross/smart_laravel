                    ...
                    <form method="POST" action="{{ route('form_prestart.update', $form_prestart->id) }}">
                        ...
                        <div class="form-group row">                            
                            <div class="col-md-6">
                                ...
                                <input id="dt_form" type="text" class="form-control date-picker" name="dt_form" value="{{ Carbon::parse($form_prestart->dt_form)->format('d/m/Y') }}" >
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="time" value="{{$form_prestart->time}}" >
                                @if ($errors->has('time'))
                                    <span class="invalid-feedback">
