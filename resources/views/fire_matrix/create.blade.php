    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('FireMatrixController@store')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="service_type" name="service_type" rows="4">{{ old('service_type') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">                                
                                <textarea class="form-control" id="wall_type" name="wall_type" rows="4">{{ old('wall_type') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="wall_type_ref" name="wall_type_ref" rows="4">{{ old('wall_type_ref') }}</textarea>                                
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="fire_stop_sys" name="fire_stop_sys" rows="4">{{ old('fire_stop_sys') }}</textarea>                                                                
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">                                
                                <input id="test_report_ref" type="text" class="form-control{{ $errors->has('test_report_ref') ? ' is-invalid' : '' }}" name="test_report_ref" value="{{ old('test_report_ref') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <textarea class="form-control" id="test_specimen" name="test_specimen" rows="4">{{ old('test_specimen') }}</textarea>                                                                                                
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="frl_achieved" type="text" class="form-control{{ $errors->has('frl_achieved') ? ' is-invalid' : '' }}" name="frl_achieved" value="{{ old('frl_achieved') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="test_dt" type="date" class="form-control{{ $errors->has('test_dt') ? ' is-invalid' : '' }}" name="test_dt" value="{{ old('test_dt') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">                                
                                <input id="approval_status" type="text" class="form-control{{ $errors->has('approval_status') ? ' is-invalid' : '' }}" name="approval_status" value="{{ old('approval_status') }}">
