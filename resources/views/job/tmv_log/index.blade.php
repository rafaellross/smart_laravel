...
<div class="container">
    <h2 style="text-align: center;">Annual TMV Service Log | {{strtoupper(App\Job::find($job)->description)}}  ({{count($tmvs)}})</h2>
    <hr/>
    <div class="form-group row">
        <div class="col-md-10 col-lg-10 col-10">
        <div class="btn-group">
            <a href="{{ URL::to('/tmv_log/' . $job . '/create') }}" class="btn btn-primary">Create New</a>
        </div>
