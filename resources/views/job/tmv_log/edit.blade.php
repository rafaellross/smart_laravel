    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('TmvLogController@update', $tmv->id)}}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select class="form-control form-control-lg custom-select" name="type">
                                  ...
                                  <option value="C" {{$tmv->type == 'C' ? 'selected' : ''}}>Commissioning Report - Temperature &  Thermal Shutoff test</option>
                                  <option value="A" {{$tmv->type == 'A' ? 'selected' : ''}}>12 Month Annual Temperature - Temperature &  Thermal Shutoff test</option>
                              </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_1" name="task_tk_1" {{$tmv->task_tk_1 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_1">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_1">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_1" rows="3">{{$tmv->task_rmk_1}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row alert">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_2" name="task_tk_2" {{$tmv->task_tk_2 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_2">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_2">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_2" rows="3">{{$tmv->task_rmk_2}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row alert">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_3" name="task_tk_3" {{$tmv->task_tk_3 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_3">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_3">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_3" rows="3">{{$tmv->task_rmk_3}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row alert">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_4" name="task_tk_4" {{$tmv->task_tk_4 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_4">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_4">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_4" rows="3">{{$tmv->task_rmk_4}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row alert">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_5" name="task_tk_5" {{$tmv->task_tk_5 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_5">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_5">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_5" rows="3">{{$tmv->task_rmk_5}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row alert">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_6" name="task_tk_6" {{$tmv->task_tk_6 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_6">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_6">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_6" rows="3">{{$tmv->task_rmk_6}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row alert">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox form-control-lg">
                                      <input type="checkbox" class="custom-control-input" id="task_tk_7" name="task_tk_7" {{$tmv->task_tk_7 ? 'checked' : ''}}>
                                      <label class="custom-control-label" for="task_tk_7">Completed?</label>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                   <label for="task_rmk_7">Remarks:</label>
                                   <textarea class="form-control" name="task_rmk_7" rows="3">{{$tmv->task_rmk_7}}</textarea>
                                 </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-lg" name="endorsed_by1" value="{{ $tmv->endorsed_by1 }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-lg" name="endorsed_position1" value="{{ $tmv->endorsed_position1 }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="hidden" name="hidden_endorsed1_sig" id="hidden_endorsed1_sig" value="{{ $tmv->endorsed1_sig }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="therm_shutoff_pass" name="therm_shutoff_pass" class="custom-control-input" {{ $tmv->therm_shutoff ? 'checked' : '' }}>
                                <label class="custom-control-label" for="therm_shutoff_pass">Passed</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="therm_shutoff_fail" name="therm_shutoff_fail" class="custom-control-input" {{ !$tmv->therm_shutoff ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-lg" name="serviceman2" value="{{ $tmv->serviceman2 }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-lg" name="serviceman2_lic" value="{{ $tmv->serviceman2_lic }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="hidden" name="hidden_serviceman2_sig" id="hidden_serviceman2_sig" value="{{ $tmv->serviceman2_sig }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-lg" name="endorsed_by2" value="{{ $tmv->endorsed_by2 }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-lg" name="endorsed_position2" value="{{ $tmv->endorsed_position2 }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="hidden" name="hidden_endorsed2_sig" id="hidden_endorsed2_sig" value="{{ $tmv->endorsed2_sig }}">
                        ...
                        <div class="form-group row" role="alert">
                            <div class="alert alert-secondary col-12">
                                ...
                                <div class="input-group col-12 mb-3">
                                    <img id="medical_certificates[1]_img" class="img-fluid" style="" src="{{ $tmv->photo }}"/>
                                </div>
                                <input id="medical_certificates[1]-delete" type="button" class="btn btn-danger btn-sm ml-2 delCert" value="Delete">
                                <input type="hidden" class="custom-file-input" id="medical_certificates[1]_hidden" name="photo_hidden" value="{{$tmv->photo}}">
                            </div>
                        </div>
