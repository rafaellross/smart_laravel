                        ...
                        <div class="form-row" style="text-align: center;">
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <select class="form-control form-control-lg custom-select " name="rdo">
                                    <?php for($i = 0; $i <= (40*60); $i += 60): ?>        
                                        <option value="<?php echo e($i); ?>" <?php echo e(isset($timesheet) && $timesheet->rdo == $i ? 'selected' : ''); ?>><?php echo e(date('i:s', $i)); ?></option>
                                    <?php endfor; ?>                                                
                                </select>
                            </div>
                        </div>
                        <div class="form-row" style="text-align: center;">
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <select class="form-control form-control-lg custom-select " name="anl">
                                    <?php for($i = 0; $i <= (40*60); $i += 60): ?>        
                                        <option value="<?php echo e($i); ?>" <?php echo e(isset($timesheet) && $timesheet->anl == $i ? 'selected' : ''); ?>><?php echo e(date('i:s', $i)); ?></option>
                                    <?php endfor; ?>                                                
                                </select>
                            </div>
                        </div>
